...
class ExMovieList extends Component {
    // Chuyển từ [{},{},{}] => [div.col-4, div.col-4, div.col-4]
    renderMovies = () => {
        // C1:
        // const htmlArr = [];
        // for (let item of data) {
        //     // data[i] === item: unshirt, splice, push, pop, shirt
        //     // htmlArr.push(); Thêm vào cuối mảng 
        //     // htmlArr.unshift; Thêm vào đầu mảng
        //     // htmlArr.splice; Remove item in Array
        //     // htmlArr.pop; Remove first item in array 
        //     // htmlArr.shift; Remove last item in array 
        //     htmlArr.push(
        // <div className="col-4" key={item.maPhim}>
        //     <div className="card mt-1">
        //         <img src={item.hinhAnh} alt="movie Item" />
